...
#define PATH(name)                      "/home/gala/.config/dwmblocks/blocks/"name
...
/*      pathu                           pathc                           interval        signal */
	...
	{ PATH("dwm_spotify.sh"),          NULL,                          1,             0},
	{ PATH("disk.sh"),          NULL,                          60,             0},
	{ PATH("uptime.sh"),        PATH("uptime_button.sh"),                          60,             3},
        { PATH("vol.sh"),          PATH("vol_button.sh"),                          30,             2},
	{ PATH("cpu.sh"),          NULL,                          3,             0},
	{ PATH("ram.sh"),          NULL,                          1,             0},
	{ PATH("lan_ip.sh"),          NULL,                          10,             0},
	{ PATH("calendar.sh"),          PATH("calendar_button.sh"),                          1 ,             1},
